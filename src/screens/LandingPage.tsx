  ...
  return (
    ...
    >
      <textarea
        ...
        className="w-full text-center text-2xl z-10 sm:text-4xl lg:text-6xl border-b-4 focus:outline-none placeholder-opacity-75 bg-transparent resize-none overflow-hidden leading-tight"
      ...
      <div className="w-5/6 sm:w-4/6 flex flex-col items-center">
        <input
          type="datetime-local"
          className="w-full text-center z-10 text-sm sm:text-lg md:text-xl lg:text-2xl xl:text-3xl border rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          value={dateTime}
          onChange={(e) => setDateTime(e.target.value)}
        />
        <div className="text-sm z-10 sm:text-md lg:text-xl">
          Select Date and Time
        </div>
      </div>
      <button
        className="text-xl z-10  px-8 py-4 rounded-2xl mt-2"
